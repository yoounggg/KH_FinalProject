...
//	@Disable
	...
	void testList() throws Exception {		
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/notice/list");
...
//	@Disable
	...
	void testGet() throws Exception {		
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/notice/get");
...
//		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/board/get");
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/notice/register");
		requestBuilder.param("title", "꼮 어드민으로 제약했으면 이걸루해야되냐");
		requestBuilder.param("content", "ㄱ시발");
...
//		 ========= Step.1 4번 no 게시글을 상세 조회 =========
		...
		MockHttpServletRequestBuilder requestBuilder 
			= MockMvcRequestBuilders.get("/notice/get");
...
//		String content = vo.getContent();
		...
		requestBuilder = MockMvcRequestBuilders.post("/notice/modify");
...
//		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/board/get");
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/notice/remove");
