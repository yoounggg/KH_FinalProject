...
//	@Disable
	...
	void testList() throws Exception {		
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/faq/list");
...
//	@Disable
	...
	void testGet() throws Exception {		
		...
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/faq/get");
...
//		 ========= Step.1 4번 no 게시글을 상세 조회 =========
		...
		MockHttpServletRequestBuilder requestBuilder 
			= MockMvcRequestBuilders.get("/faq/get");
...
//		String content = vo.getContent();
		...
		requestBuilder = MockMvcRequestBuilders.post("/faq/modify");
...
//		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/board/get");
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/faq/remove");
