...
<!-- 메인 - 공지사항 글 목록 테이블, 이동페이지, 수정, 삭제 -->            
        ...
        <div class="content">
            <table id="list">
                ...
                <tbody>
                    <c:forEach items="${searchList}" var="NoticeDTO">
                        <tr>
						    ...
						    <div class="pageInfo_area">
						    	<ul id="pageInfo" class="pageInfo">
									...
									<c:forEach var="num" begin="${__PAGE_MAKER__.startPage}" end="${__PAGE_MAKER__.endPage}">
							        	<li class="searchbutton"><a href="/admin/notice/search?keyword=${__PAGE_MAKER__.cri.keyword}&currPage=${num}&amount=${__PAGE_MAKER__.cri.amount}">${num}</a></li>
							        </c:forEach>
