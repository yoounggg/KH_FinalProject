					    ...
					    <div class="pageInfo_area">
					    	<ul id="pageInfo" class="pageInfo">
					            ...
					            <c:if test="${pageMaker.prev}" >
					                <li class="pageInfo_btn previous"><a href="/admin/farm/list?currPage=${pageMaker.startPage-1}">Previous</a></li>
					            </c:if>
					            ...
					            <c:if test="${pageMaker.next}" >
					                <li class="pageInfo_btn next"><a href="/admin/farm/list?currPage=${pageMaker.endPage + 1}&amount=${pageMaker.cri.amount}">Next</a></li>
					            </c:if>  
				             </ul>
								<div class="button1">
