...
public interface OrderMapper {
	...
	// 주문 완료 시 장바구니 상품 정보 삭제
	public Integer deleteOrderCart(CartDTO dto);
	
	//==========================================================
	
	// 주문 완료 시 주문자 정보 db에 요청
	public OrderDTO getOrderList(OrderDTO ord);
	
	// 주문 완료 시 주문상품 정보 db에 요청
	public OrderItemDTO getOrderItemList(OrderItemDTO oit);
