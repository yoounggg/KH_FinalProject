...
public interface CartService { // 인터페이스
	...
	public abstract Integer addProductsInCart(CartDTO cart) throws ServiceException;

	// 2. 장바구니 정보 리스트 (영속성에서  List<CartVO> getCart(String member_id);)
	public abstract List<CartDTO> getCart(String member_id);
//	public List<CartVO> getCart(String member_id);
	
	// 3. 장바구니 수량 수정 (영속성에서 modifyCount(CartDTO cart))
	public abstract Integer modifyCount(CartDTO cart); 
	
	//4. 장바구니 삭제
	public abstract Integer deleteCart(Integer no); 
